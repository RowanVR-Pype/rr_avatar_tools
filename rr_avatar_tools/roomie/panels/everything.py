...
import rr_avatar_tools.roomie.operators


class SCENE_PT_RRRoomieToolsEverythingPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        for package in rr_avatar_tools.roomie.operators.packages:
...
classes = (SCENE_PT_RRRoomieToolsEverythingPanel,)
